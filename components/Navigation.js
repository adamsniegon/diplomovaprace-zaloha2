    ...
    return (
        <ul className="navigation">
            <li className="navigation__item">
                <Link href="/map">
                    <a className={"navigation__link" + (pathname.startsWith('/map') ? " navigation__link--active": "")}>
            ...
            <li className="navigation__item">
                <Link href="/">
                <a className={"navigation__link" + ((!pathname.startsWith('/map') && !pathname.startsWith('/profile')) ? " navigation__link--active" : "")}>
            ...
            <li className="navigation__item">
                <Link href="/profile">
                <a className={"navigation__link" + (pathname.startsWith('/profile') ? " navigation__link--active": "")}>
                        <svg className="navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.361 17.344">
                            <g className="navigation__iconGroup" fill="none" stroke="#8c8c8c" strokeWidth="1.109">
                                <path className="navigation__path" d="M10.479 4.341A3.787 3.787 0 016.7 8.128a3.787 3.787 0 01-3.795-3.77A3.787 3.787 0 016.668.554a3.787 3.787 0 013.81 3.755" strokeLinecap="round" paintOrder="stroke fill markers"/>
                                <path className="navigation__path" d="M2.957 16.79h7.472c1.655 0 3.007-.853 2.07-2.475C9.614 9.333 3.79 9.23.88 14.307c-.95 1.646.319 2.483 2.078 2.483z" strokeLinejoin="round"/>
                            </g>
                        </svg>
                    </a>
                </Link>
